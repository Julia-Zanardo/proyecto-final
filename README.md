...
Nombre del juego: Julpajulparaiso.
...
* **SDK de .NET 9.0 (x64)** - [Descargar desde el sitio oficial de Microsoft](https://dotnet.microsoft.com/es-es/download/dotnet/9.0) (Asegúrate de instalar el **SDK**, no solo el Runtime).
* **Visual Studio 2022 o posterior** con la carga de trabajo **"Desarrollo de escritorio de .NET"** activa.
* **Git** instalado en tu sistema.

 Pasos para la Ejecución
**1. Clonar el repositorio**
Abrí tu terminal en la carpeta donde quieras descargar el juego y ejecuta:
```bash
